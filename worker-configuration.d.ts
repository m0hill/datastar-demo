/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ab5b8a2debdb12cc8dfe6ce26bd7b951)
...
declare namespace Cloudflare {
  interface Env {
    ...
    TODO_RESOURCE: DurableObjectNamespace<import('./src/index').TodoResource>
    CHAT_RESOURCE: DurableObjectNamespace<import('./src/index').ChatResource>
    ASSETS: Fetcher
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
      Pick<
        Cloudflare.Env,
        'NODE_ENV' | 'CLOUDFLARE_ACCOUNT_ID' | 'CLOUDFLARE_DATABASE_ID' | 'CLOUDFLARE_D1_TOKEN'
      >
    > {}
}
declare module '*.sql' {
