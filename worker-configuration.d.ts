/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7daafae03327f2272cc3e3de990f3ded)
...
declare namespace Cloudflare {
	interface Env {
		...
		TODO_LIST: DurableObjectNamespace<import("./src/index").TodoList>;
		DB: D1Database;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN">> {}
}
